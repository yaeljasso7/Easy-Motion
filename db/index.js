...
class DB {
   ...
   *           =, <>, <, <=, >, >=, like, in
   *
   *         If there no logic operator specified, uses AND by default
   *         If there no comparison operator specified, uses = by default
   *
   *         If there no WHERE condition, all records are retrieved selected.
   *
