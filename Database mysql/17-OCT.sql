...
INSERT INTO `blog` VALUES (1,'2018-10-12 21:48:45','Francisco','En Mty...',7),(2,'2018-10-08 22:03:29','yo','En new york....',1),(5,'2018-10-09 08:36:11','yo','En new york....',1),(6,'2018-10-12 21:15:27','Paquito','En Francia ....',5),(8,'2008-05-30 05:00:00','PostTest','En PostTest  ....',NULL),(9,'2008-05-30 05:00:00','PostTest2','En PostTest  ....2',NULL),(10,'2008-05-30 00:00:00','HerokuAutor','En PostTest  ....2',NULL),(11,'2018-10-16 04:44:27','javier','jejejeje',1);
...
INSERT INTO `calendar` VALUES (1,'principiantes'),(3,'expertos'),(4,'genios'),(5,'Atletas'),(6,'Express'),(8,'Quimico extremo'),(9,'Quimico extremo');
/*!40000 ALTER TABLE `calendar` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `calendarDayRoutine`
--

DROP TABLE IF EXISTS `calendarDayRoutine`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `calendarDayRoutine` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `idCalendar` int(11) NOT NULL,
  `idRoutine` int(11) NOT NULL,
  `day` int(11) NOT NULL,
  PRIMARY KEY (`idCalendar`,`idRoutine`,`day`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `fk_routine_idx` (`idRoutine`),
  CONSTRAINT `fk_calendarDayRoutine_calendar` FOREIGN KEY (`idCalendar`) REFERENCES `calendar` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_calendarDayRoutine_routine` FOREIGN KEY (`idRoutine`) REFERENCES `routines` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `calendarDayRoutine`
--

LOCK TABLES `calendarDayRoutine` WRITE;
/*!40000 ALTER TABLE `calendarDayRoutine` DISABLE KEYS */;
INSERT INTO `calendarDayRoutine` VALUES (3,1,1,1),(6,3,3,1),(7,1,4,2),(10,5,5,2),(11,5,3,2),(12,5,3,8),(13,5,4,3),(14,8,1,1),(15,8,1,2);
/*!40000 ALTER TABLE `calendarDayRoutine` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `progressUser` VALUES (8,180,180,'2018-10-12 23:19:14'),(8,170,180,'2018-10-13 00:07:36'),(8,165,165,'2018-10-13 00:36:39'),(8,165,165,'2018-10-13 00:37:39'),(8,164,165,'2018-10-13 00:38:00'),(8,112,165,'2018-10-13 01:08:40'),(9,180,180,'2018-10-12 23:19:14'),(18,188,188,'2018-10-13 01:14:04'),(18,119,119,'2018-10-13 01:14:55'),(18,119,119,'2018-10-16 23:43:17'),(18,119,119,'2018-10-16 23:50:19'),(18,119,119,'2018-10-17 01:21:47');
...
CREATE TABLE `userCalendar` (
  ...
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `fk_userRoutine_routine` (`idCalendar`) USING BTREE,
  KEY `fk_userRoutine_user` (`idUser`) USING BTREE,
  CONSTRAINT `fk_userCalendar_idCalendar` FOREIGN KEY (`idCalendar`) REFERENCES `calendar` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_userCalendar_idUser` FOREIGN KEY (`idUser`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `userCalendar` VALUES (3,8,1,0),(7,14,5,0),(6,14,6,0),(8,15,8,0);
...
-- Dump completed on 2018-10-17  1:53:00
