...
--
-- Servidor: localhost
-- Tiempo de generación: 22-10-2018 a las 08:52:16
...
CREATE TABLE `permissions` (
  ...
  `cond` varchar(45) COLLATE utf8_unicode_ci NOT NULL DEFAULT ''
...
INSERT INTO `permissions` (`id`, `name`, `cond`) VALUES
(25, 'manageRoutines', ''),
(26, 'manageExercises', ''),
(27, 'manageTrainingTypes', ''),
(28, 'manageBodyParts', ''),
(29, 'manageCalendars', ''),
(30, 'manageUsers', ''),
(31, 'manageMyUser', 'equalsId');
...
(11, 'Diez', '', 0, 0),
(12, 'Rutina 101', '', 10, 0),
(13, 'Rutina nueva', '', 10, 0),
(14, 'Otra Rutina nueva', '', 10, 0);
...
(3, '$2b$10$Js/0vQdmzzcjwXijVb226.xM.U00mHeuZ53MrAfrUridOrRmr.JbW', 21, '1', '2018-10-21', 12, 0),
(4, '$2b$10$qawH6pij.yqd/ebwBmlyleucWl6wlD62wJodGj57Wt6jBkVMDe/Qi', 23, '1', '2018-10-21', 12, 0),
(5, '$2b$10$6tvZ8YLKrYYcKZrJoSzViu94f41DOZu3XCWqSgjQuok/oCsHJZKcm', 23, '1', '2018-10-21', 12, 1);
...
(20, 'user81', '8181818181', 81, 181, 'holasoy81', 'user81@email.com', 2, 0),
(21, 'user82', '8282828282', 82, 182, '$2b$04$Ik2ZwgrB3rV07vgja7dpfeSMyRHgqligFwx5HGBmRv4byA79wNeI6', 'user82@email.com', 2, 0),
(22, 'user88', '8888888888', 88, 188, '$2b$10$n62hRanbd.BY.PXWYTf0v.WXYaOjyLrz/NimabmNi/Up9JqbJrP7G', 'user88@email.com', 2, 0),
(23, 'user89', '', 89, 189, '$2b$10$XA6.SNrKLFEc.NT3Ui8LDOdPF5UYWW/tELCA/JiJ4V7T7ASbvuzp2', 'user89@email.com', 1, 0);
...
(20, 81, 181, '2018-10-21 20:42:40'),
(21, 82, 182, '2018-10-21 20:43:42'),
(22, 88, 188, '2018-10-21 21:51:11'),
(23, 89, 189, '2018-10-21 21:53:20');
...
--
ALTER TABLE `roles_permissions`
  ADD CONSTRAINT `fk_permission` FOREIGN KEY (`permissionId`) REFERENCES `permissions` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
